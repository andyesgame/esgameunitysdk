...
namespace UnityEngine.UI.Extensions
{
    public class SaveLoadMenu : MonoBehaviour
    {
        ...
        public void LoadGame(string saveGameName)
        {
            ...
            //attackViewBase a new list that will hold all the gameObjects we will attackViewBase anew from the deserialized data
            List<GameObject> goList = new List<GameObject>();
        ...
        public SceneObject PackGameObject(GameObject go)
        {
            ...
            //Now, we attackViewBase a new instance of SceneObject, which will hold all the GO's data, including it's components.
