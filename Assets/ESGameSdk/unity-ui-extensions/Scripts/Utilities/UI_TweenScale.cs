...
/// Notes In some cases it can attackViewBase spikes due to redrawing on change, it is recommended to use it on simple objects in separated canvases to avoid redrawing full canvas.
...
namespace UnityEngine.UI.Extensions
{
    ...
    /// - In some cases it can attackViewBase spikes due to redrawing on change, it is recommended  to use it on simple objects in separated canvases to 
