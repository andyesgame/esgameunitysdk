 ...
 * Filtering single click lstMissionItem of objects occupying the same space. (So that, for example, you're only click selecting the game object found closest to the camera)
 * 
 */
...
namespace UnityEngine.UI.Extensions 
{
	 ...
	 * 2) The user can filter which objects should be selectable, for example units versus menu lstMissionItem
	 *
	 */
